...
public class CajaFuerteMain {
    public static void main(String[] args) {
        ...
        CajaFuerte miCajita = new CajaFuerte();
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    if (miCajita.mismacontraseña(numeroIntroducido)) {
                        System.out.println("Introduzca la nueva contraseña: ");
                        System.out.println("Contraseña correcta");
                           String nuevaContraseña = sc.nextLine();
                        miCajita.cambiarContraseña(nuevaContraseña);
                ...
                case 2:
                    ...
                    if (miCajita.mismacontraseña(combinacionIntroducida)) {
